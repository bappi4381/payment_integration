...
class SslCommerzPaymentController extends Controller
{
    ...
    public function exampleEasyCheckout($product)
    {
        // Fetch product by ID (or slug if needed)
        $product = Product::find($product); // Replace with actual logic

        if (!$product) {
            abort(404, 'Product not found');
        }

        return view('exampleEasycheckout', compact('product'));
    }
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $post_data = [
            ...
            'currency' => "BDT",
            'tran_id' => uniqid(),
            'cus_name' => $re_post_data->input('cus_name'),
            'cus_email' => $re_post_data->input('cus_email'),
            'cus_add1' => $re_post_data->input('cus_add1'),
            'cus_phone' => $re_post_data->input('cus_phone'),
            'ship_name' => $re_post_data->input('cus_name'),
